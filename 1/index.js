 ...
 * Water
 */
var water, materials, controls, renderer, scene, camera;
var parameters = {
    width: 2000,
    height: 2000,
    widthSegments: 250,
...
function init() {
    ...
    scene.add(light);
    // Water texture
    var waterNormal = require('./images/waternormals.jpg');
    ...
    var skyboxTexture = require('./images/skyboxsun5deg2.png');
    loader.load(skyboxTexture, function (image) {
